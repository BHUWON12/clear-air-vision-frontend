...
def generate_dummy_prediction(data):
    # Use input data to create a more realistic prediction<svg width="28" height="28" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.15463 1.14036C9.34195 0.953254 9.64542 0.953206 9.83281 1.14026L11.4597 2.76427C11.6475 2.95175 11.6475 3.25606 11.4597 3.44354L6.89466 8.00081L11.4561 12.5571C11.6437 12.7444 11.6438 13.0484 11.4563 13.2359L9.83281 14.8594C9.64547 15.0468 9.34177 15.0469 9.15433 14.8596L4.27924 9.99011C4.26927 9.98164 4.25956 9.9727 4.25015 9.96329L2.62654 8.33968C2.53297 8.24611 2.48612 8.12351 2.48598 8.00087C2.48575 7.87775 2.5326 7.75456 2.62654 7.66062L4.25005 6.03711C4.25946 6.02769 4.26918 6.01875 4.27915 6.01028L9.15463 1.14036Z" fill="white"/>
  <path fill-rule="evenodd" clip-rule="evenodd" d="M11.631 6.61035C10.8746 6.61035 10.262 7.2229 10.262 7.97933C10.262 8.73576 10.8746 9.34831 11.631 9.34831C12.3875 9.34831 13 8.73165 13 7.97933C13 7.22701 12.3875 6.61035 11.631 6.61035Z" fill="#F37321"/>
  </svg>
...
# About page
    ...
    <div style="text-align:center; margin-top:30px; padding:15px; font-size:0.9em; color:#666;">
        <p>Clear Air Vision v2.0 | Created with ❤️ by Clear Air Vision</p>
